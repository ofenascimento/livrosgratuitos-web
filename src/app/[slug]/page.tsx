                        ...
                        <div className=" flex justify-between items-center">
                            ...
                            <div className=" flex justify-center items-center gap-2">
                                <div>
                                    {isFavorited ? (
                                        ...
                                        >
                                            ...
                                            <p className="hidden lg:block font-raleway font-semibold">Favoritado</p>
                                        </button>
                                    ) : (
                                        <button
                                            className="rounded-full border border-slate-600 bg-dark-background p-3 lg:px-4 lg:py-2  flex justify-center items-center gap-3"
                                        ...
                                        >
                                            ...
                                            <p className="hidden lg:block font-raleway font-semibold">Favoritar</p>
                                        </button>
                                    )}
                                </div>
                                <button
                                ...
                                >
                                    ...
                                    <p className="hidden lg:block font-raleway font-semibold">Compartilhar</p>
                                </button>
                            </div>
                        </div>
